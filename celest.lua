    ...
    function window:CreateTab(props)
        ...
        function tab:CreateSubTab(subProps)
            ...
            if not self.subTabs then
                ...
                self.subTabFrame.Position = UDim2.new(Mainframe.Position.X.Scale, Mainframe.Position.X.Offset, Mainframe.Position.Y.Scale, Mainframe.Position.Y.Offset + Mainframe.Size.Y.Offset + 5)
