...
function Leaf:CreateWindow(config)
    ...
    UIStroke3.Color = Color3.fromRGBопа80, 80, 80)
    ...
    function window:CreateTab(props)
        ...
        function tab:CreateSubTab(props)
            ...
            if not self.subTabBar then
                self.subTabBar = Instance.new("Frame")
                self.subTabBar.Name = "SubTabBar"
                self.subTabBar.Parent = self.ScrollingFrame.Parent
                self.subTabBar.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
                self.subTabBar.BorderSizePixel = 0
                self.subTabBar.Position = UDim2.new(0, 0, 0, 0)
                self.subTabBar.Size = UDim2.new(1, 0, 0, 20)
                local subTabStroke = Instance.new("UIStroke")
                subTabStroke.Parent = self.subTabBar
            ...
            subTab.opened = props.Opened
            subTab.contentFrame = Instance.new("Frame")
            subTab.contentFrame.Name = "SubTabContent_"..props.Name
            subTab.contentFrame.Parent = self.ScrollingFrame
            subTab.contentFrame.BackgroundTransparency = 1
            subTab.contentFrame.Size = UDim2.new(1, 0, 1, 0)
            subTab.contentFrame.Visible = subTab.opened
            subTab.nextPosition = 10
            subTab.requiredCanvasSize = 10
            subTab.window = self.window
            local button = Instance.new("TextButton")
            button.Name = "SubTabButton_"..props.Name
            button.Parent = self.subTabBar
            button.BackgroundTransparency = 1
            button.Size = UDim2.new(0, 78, 1, 0)
            button.Font = Enum.Font.GothamBold
            button.Text = props.Name
            button.TextSize = subTab.opened and 14 or 13
            button.TextColor3 = subTab.opened and Leaf.MenuColorValue.Value or Color3.fromRGB(130, 130, 130)
            subTab.button = button
            table.insert(self.subTabs, subTab)
            local n = #self.subTabs
            local W = 310
            for i, st in ipairs(self.subTabs) do
                local centerX = (i / (n + 1)) * W
                st.button.Position = UDim2.new(0, centerX - 39, 0, 0)
            end
            if subTab.opened then
                ...
                self.ScrollingFrame.CanvasSize = UDim2.new(0, 0, 0, subTab.requiredCanvasSize)
            end
            ...
            subTab.Button = function(self, props)
                local ButtonFrame = Instance.new("Frame")
                local UICornerBtn = Instance.new("UICorner")
                local Indicator = Instance.new("Frame")
                local UICornerInd = Instance.new("UICorner")
                ...
                self.nextPosition = self.nextPosition + 45
                self.requiredCanvasSize = self.nextPosition + 10
                if self == tab.activeSubTab then
                    tab.ScrollingFrame.CanvasSize = UDim2.new(0, 0, 0, self.requiredCanvasSize)
                end
            end
            subTab.DeButton = function(self, props)
                local DeButtonFrame = Instance.new("Frame")
                local UICornerDeBtn = Instance.new("UICorner")
                local NameButton = Instance.new("TextLabel")
                local TextButton = Instance.new("TextButton")
            ...
            subTab.Toggle = function(self, props)
                local ToggleFrame = Instance.new("Frame")
                local UICornerTog = Instance.new("UICorner")
                local Indicator = Instance.new("Frame")
                local UICornerInd = Instance.new("UICorner")
            ...
            subTab.Slider = function(self, props)
                local min = props.Value.Min
                local max = props.Value.Max
                local increment = props.Value.Increment
                local default = props.Value.Default
            ...
            subTab.Section = function(self, props)
                local SectionFrame = Instance.new("Frame")
                local UICornerSec = Instance.new("UICorner")
                local SectionTitle = Instance.new("TextLabel")
                local Underline = Instance.new("Frame")
            ...
            subTab.CreateDropdown = function(self, props)
                local DropdownFrame = Instance.new("Frame")
                local UICornerDrop = Instance.new("UICorner")
                local Dropdownname = Instance.new("TextLabel")
                local TextButton = Instance.new("TextButton")
            ...
            subTab.CreateColorPicker = function(self, props)
                local Name = props.Name
                local Color = props.Color
                local Callback = props.Callback
            ...
            subTab.Input = function(self, props)
                local InputFrame = Instance.new("Frame")
                local UICornerInp = Instance.new("UICorner")
                local NameLabel = Instance.new("TextLabel")
                local InputBox = Instance.new("TextBox")
