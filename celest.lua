...
function Leaf:CreateWindow(config)
    ...
    function window:CreateTab(props)
        ...
        function tab:CreateSubTab(subTabProps)
            ...
            if not self.SubTabFrame then
                ...
                subTabFrame.Parent = Mainframe.Parent
                subTabFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
                subTabFrame.BorderSizePixel = 0
                subTabFrame.Position = UDim2.new(Mainframe.Position.X.Scale, Mainframe.Position.X.Offset, Mainframe.Position.Y.Scale, Mainframe.Position.Y.Offset - 22)
                subTabFrame.Size = UDim2.new(0, 310, 0, 20)
                subTabFrame.Visible = self.ScrollingFrame.Visible
                self.SubTabFrame = subTabFrame
                ...
                self.ScrollingFrame.Position = UDim2.new(0.015, 0, 0.191, 0)
                Mainframe.Position = UDim2.new(0.015, 0, 0.28, 0)
                Mainframe.Size = UDim2.new(0, 310, 0, 178)
                self.ScrollingFrame.Size = UDim2.new(0, 309, 0, 178)
            end

            local subTab = {}
            local button = Instance.new("TextButton")
            button.Name = subTabProps.Name
            ...
            local function updateSubTabPositions()
                ...
                elseif numSubTabs == 2 then
                    self.subTabs[1].Button.Position = UDim2.new(0.25, -39, 0, 0)
                    self.subTabs[2].Button.Position = UDim2.new(0.75, -39, 0, 0)
                elseif numSubTabs == 3 then
                    self.subTabs[1].Button.Position = UDim2.new(0.106, 0, 0, 0)
                    self.subTabs[2].Button.Position = UDim2.new(0.5, -39, 0, 0)
                    self.subTabs[3].Button.Position = UDim2.new(0.894, -78, 0, 0)
                end
            end
            
            local function setActiveSubTab(selectedSubTab)
                for _, otherSubTab in ipairs(self.subTabs) do
                    if otherSubTab == selectedSubTab then
                        otherSubTab.Button.TextColor3 = Leaf.MenuColorValue.Value
                        otherSubTab.Button.TextSize = 14.000
                    else
                        otherSubTab.Button.TextColor3 = Color3.fromRGB(130, 130, 130)
                        otherSubTab.Button.TextSize = 13.000
                    end
                end
                if subTabProps.Callback then
                    pcall(subTabProps.Callback)
                end
            end
